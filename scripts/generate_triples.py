...
def get_triples_from_gt(gt_boxes, ent_labels, ent_attrs, rel_mat, pred_use_prob, use_none_label):
...
if __name__ == "__main__":
    ...
    attr_dict_path = "cache/attr_dict.json"
    ...
    attr_dict = SymbolDictionary.load_from_file(attr_dict_path)
    ...
    for split, sg_file in tqdm(zip(splits, scene_graph_files)):
        ...
        for image_id, scene_graph in tqdm(scene_graphs.items()):
            ...
            gt_entries = get_triples_from_gt(ent_boxes, ent_labels, ent_attrs, rel_mat, pred_use_prob, use_none_label)
